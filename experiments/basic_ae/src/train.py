...
def train_ae(hidden_dim=32, epochs=100, batch_size=128, learning_rate=1e-3, early_stopping_patience=10):
    # Set device
    device = get_device()
    ...
    for epoch in range(epochs):
        ...
        if avg_val_loss < best_loss:
            ...
            patience_counter = 0
            best_model_path = os.path.join(best_model_dir, 'ae_best.pth')
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Train Basic Autoencoder on MNIST')
